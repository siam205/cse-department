    ...
    <form action={formAction} className="space-y-6">
      ...
      <Card title="Hero image">
        <p className="text-xs text-gray-500 -mt-2">
          This image appears in the page header. It is separate from the document cover image below.
        </p>
        <ImageUploader
          kind="department-layout-hero"
          name="heroImage"
          aspectRatio="wide"
          label="Hero image"
      ...
      <Card title="Department layout PDF">
        <p className="text-xs text-gray-500 -mt-2">
          This PDF is delivered through the site download route so protected Cloudinary files remain accessible.
        </p>
        <ImageUploader
