...
export const metadata = { title: 'Clubs (CMS)' };
...
export default async function ClubsAdminPage() {
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      <header>
        <h1 className="text-2xl font-display font-bold text-gray-900">Clubs</h1>
        <p className="mt-1 text-sm text-gray-500">
          Directory for <code className="font-mono">/student-society/club-list</code>. Drag to reorder.
        </p>
      </header>
      <section className="space-y-3">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-500">Clubs</h2>
