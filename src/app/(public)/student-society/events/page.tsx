...
export const metadata = {
  title: 'Events — Department of Computer Science & Engineering',
  description:
    'Departmental events from the CSE Department at Sonargaon University — sports, industrial visits, seminars, exhibitions.',
};
