...
export const metadata = {
  title: 'Mission & Vision — Department of Computer Science & Engineering',
  description:
    'The mission and vision of the Department of Computer Science & Engineering, Sonargaon University.',
};
