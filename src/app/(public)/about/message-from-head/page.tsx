...
export const metadata = {
  title: 'Message from Head — Department of Computer Science & Engineering',
  description:
    'Welcome message from the Head of the Department of Computer Science & Engineering, Sonargaon University.',
};
